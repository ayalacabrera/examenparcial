    ...
    try {
      if (confirm('Are you sure you want to delete this propiedades?')) {
        ...
        if (res.status === 204) {
          ...
          prevPropiedades.filter((propiedad) => propiedad.id_propiedades !== propiedadId)
          );
        }
      }
    } catch (error) {
          ...
          {propiedades.map((propiedad, index) => {
              ...
              <tr key={index} className="border-b hover:bg-gray-100">
                <td className="whitespace-nowrap px-6 py-4"> <button
                      ...
                      onClick={() => deletePropiedad(propiedad.id_propiedades)}
                    >
                      Delete
                    </button> </td>
                <td className="whitespace-nowrap px-6 py-4">{propiedad.id_propiedades}</td>
                ...
                <td className="whitespace-nowrap px-6 py-4">{propiedad.update_at}</td>
              </tr>
              ); 
          })}
          </tbody>
